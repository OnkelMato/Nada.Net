...
public class RangeCheckTests
{
    ...
    [Test]
    public void Ctor_MaxLessOrEqualMinTests_Throw()
    {
    ...
    [Test]
    public void Ctor_NegativeLengthTests_Throw()
    {
    ...
    {
        var settings =
            new Dictionary<string, string> { { "Min", "2" }, { "Max", "42" } } as IDictionary<string, string>;
        var ctx = new ContextFor<RangeCheck>();
        ctx.Use(settings);
        var sut = ctx.BuildSut();
